...
public class ModPainting {
    ...
    public static final RegistryObject<PaintingVariant> BLOOD_STRIKE_1 = PAINTINGS.register("blood_strike_1", () -> new PaintingVariant(2, 2, ResourceLocation.fromNamespaceAndPath(GunMod.MOD_ID, "blood_strike_1")));
