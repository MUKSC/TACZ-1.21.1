 ...
 * @param <T> 数据类型
 */
public class JsonDataManager<T> extends SimplePreparableReloadListener<JsonDataManager.PreparedResult<T>> {
    ...
    public JsonDataManager(Class<T> dataClass, Gson pGson, String directory, String marker) {
        this(dataClass, pGson, FileToIdConverter.json(directory), marker, id -> true);
    }
    ...
    public JsonDataManager(Class<T> dataClass, Gson pGson, String directory, String marker, Predicate<ResourceLocation> eagerLoadPredicate) {
        this(dataClass, pGson, FileToIdConverter.json(directory), marker, eagerLoadPredicate);
    }

    public JsonDataManager(Class<T> dataClass, Gson pGson, FileToIdConverter fileToIdConverter, String marker, Predicate<ResourceLocation> eagerLoadPredicate) {
        this.gson = pGson;
