...
local function runReloadAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 3) then
            context:runAnimation("reload_empty_xmag4", track, false, PLAY_ONCE_STOP, 0.2)   
        else
            context:runAnimation("reload_empty", track, false, PLAY_ONCE_STOP, 0.2)
        end
    else
        ...
        elseif (ext == 3) then
            context:runAnimation("reload_norm_xmag4", track, false, PLAY_ONCE_STOP, 0.2)    
        else
            context:runAnimation("reload_tactical", track, false, PLAY_ONCE_STOP, 0.2)
        end
    end
...
local function runInspectAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 3) then
            context:runAnimation("inspect_empty_xmag4", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("inspect_empty", track, false, PLAY_ONCE_STOP, 0.2)
        end
    else
        ...
        elseif (ext == 3) then
            context:runAnimation("inspect_xmag4", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("inspect", track, false, PLAY_ONCE_STOP, 0.2)
        end
    end
